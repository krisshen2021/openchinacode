...
export const Model = Schema.Struct({
  ...
  task_classes: Schema.optional(Schema.mutable(Schema.Array(ConfigTaskPolicy.TaskKind))).annotate({
    description: "OpenChinaCode task kinds this model is preferred for.",
  }),
