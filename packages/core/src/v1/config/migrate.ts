...
export function migrate(info: typeof ConfigV1.Info.Type) {
  return {
    ...
    shell: info.shell,
    model: info.model,
    auto_maxtokens: info.auto_maxtokens,
    task_policy: info.task_policy,
    integration_test: info.integration_test,
    ...
    compaction: info.compaction && {
      ...
      retention_enabled: info.compaction.retention_enabled,
      reasoning_retention_turns: info.compaction.reasoning_retention_turns,
      tool_output_retention_turns: info.compaction.tool_output_retention_turns,
      attachment_retention_turns: info.compaction.attachment_retention_turns,
    },
