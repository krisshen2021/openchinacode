...
describe("prompt slash commands", () => {
  ...
  test("parses retention turns actions", () => {
    ...
    expect(parseRetentionTurnsSlashAction("default")).toEqual({ type: "default" })
    expect(parseRetentionTurnsSlashAction("inherit")).toEqual({ type: "default" })
    expect(parseRetentionTurnsSlashAction("unset")).toEqual({ type: "default" })
  ...
  test("parses token optimization actions", () => {
    ...
    expect(parseTokenOptimizationSlashAction("default")).toEqual({ type: "default" })
    expect(parseTokenOptimizationSlashAction("inherit")).toEqual({ type: "default" })
