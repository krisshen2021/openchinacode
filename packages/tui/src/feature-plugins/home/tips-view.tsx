...
const TIPS: Tip[] = [
  ...
  "Run {highlight}/connect{/highlight} to add API keys for GLM, Kimi, and DeepSeek",
  ...
  "Run {highlight}/lsp on{/highlight} to enable built-in LSP servers for code analysis",
  ...
  "Create a plugin to prevent OpenChinaCode from reading sensitive files",
  "Use {highlight}openchinacode run{/highlight} for non-interactive scripting",
  "Use {highlight}openchinacode --continue{/highlight} to resume the last session",
  "Use {highlight}openchinacode run -f file.ts{/highlight} to attach files via CLI",
  "Use {highlight}--format json{/highlight} for machine-readable output in scripts",
  "Run {highlight}openchinacode serve{/highlight} for headless API access to OpenChinaCode",
  "Use {highlight}openchinacode run --attach{/highlight} to connect to a running server",
  "Run {highlight}openchinacode upgrade{/highlight} to update to the latest version",
  "Run {highlight}openchinacode providers list{/highlight} to see all configured providers",
  "Run {highlight}openchinacode agent create{/highlight} for guided agent creation",
  "Use {highlight}/opencode{/highlight} in GitHub issues/PRs to trigger AI actions",
  "Run {highlight}openchinacode github install{/highlight} to set up the GitHub workflow",
  ...
  "Run {highlight}openchinacode debug config{/highlight} to troubleshoot configuration",
