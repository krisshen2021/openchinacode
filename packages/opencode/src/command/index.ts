...
const PROMPT_TASK_POLICY = [
  ...
  "- complex review, implement, summarize, and all compaction: zhipuai-pay2go/glm-5.2#high",
  "- quick/medium review, implement, summarize, and quick explore: moonshotai-cn/kimi-k2.7-code-highspeed",
  "- medium explore: zhipuai-pay2go/glm-5.2#high",
  "- complex explore: zhipuai-pay2go/glm-5.2#max",
  "- visual_check: zhipuai-pay2go/glm-5v-turbo",
  "- debug, test_fix: deepseek/deepseek-v4-pro",
  "",
