...
// position is not chronological. Derive each binding by created time so a
// pre-compaction overflowing tail assistant doesn't get mistaken for the
// most recent turn. Do not compare raw IDs here: IDs generated before the
// 48-bit time-field wrap (2026-08-14) sort after newer IDs. tasks are
...
export function fromError(
  ...
  switch (true) {
    ...
    case ContextOverflowError.isInstance(e):
      if ("toObject" in e && typeof e.toObject === "function") return e.toObject()
