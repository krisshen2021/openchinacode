      ...
      const result = yield* taskTool
        .execute(taskArgs, {
          ...
          extra: {
            ...
            promptOps,
            explicitTaskModel: task.model !== undefined,
            taskModel: { providerID: taskModel.providerID, modelID: taskModel.id },
          },
          messages: msgs,
      ...
      function* (sessionID: SessionID) {
        ...
        while (true) {
          ...
          if (
            ...
            !hasToolCalls &&
            MessageV2.after(lastAssistant, lastUser)
          ) {
        ...
        ? [
            {
              ...
              command: input.command,
              ...(explicitTaskModel ? { model: { providerID: taskModel.providerID, modelID: taskModel.modelID } } : {}),
