...
test("parseModel handles model IDs with slashes", () => {
  const result = Provider.parseModel("moonshotai-cn/moonshot/kimi-k2.7-code")
  expect(String(result.providerID)).toBe("moonshotai-cn")
  expect(String(result.modelID)).toBe("moonshot/kimi-k2.7-code")
})
