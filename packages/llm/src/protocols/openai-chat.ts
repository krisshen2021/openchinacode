...
const lowerOptions = Effect.fn("OpenAIChat.lowerOptions")(function* (request: LLMRequest) {
  ...
  const providerOptions = request.providerOptions?.[request.model.provider]
  const thinking = isRecord(providerOptions?.thinking) ? providerOptions.thinking : undefined
